...
public class MoonstoneDustItem extends ZeloopaModElements.ModElement {
	@ObjectHolder("zeloopa:moonstone_dust")
	public static final Item block = null;
	public MoonstoneDustItem(ZeloopaModElements instance) {
		super(instance, 180);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("moonstone_dust");
		}
