...
public class EboniteDustItem extends ZeloopaModElements.ModElement {
	@ObjectHolder("zeloopa:ebonite_dust")
	public static final Item block = null;
	public EboniteDustItem(ZeloopaModElements instance) {
		super(instance, 155);
	}
