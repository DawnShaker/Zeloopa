...
public class GoldenDustItem extends ZeloopaModElements.ModElement {
	@ObjectHolder("zeloopa:golden_dust")
	public static final Item block = null;
	public GoldenDustItem(ZeloopaModElements instance) {
		super(instance, 196);
	}
