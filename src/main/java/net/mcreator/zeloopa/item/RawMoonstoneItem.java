...
public class RawMoonstoneItem extends ZeloopaModElements.ModElement {
	@ObjectHolder("zeloopa:raw_moonstone")
	public static final Item block = null;
	public RawMoonstoneItem(ZeloopaModElements instance) {
		super(instance, 101);
	}
