...
public class DwemerDustItem extends ZeloopaModElements.ModElement {
	@ObjectHolder("zeloopa:dwemer_dust")
	public static final Item block = null;
	public DwemerDustItem(ZeloopaModElements instance) {
		super(instance, 161);
	}
