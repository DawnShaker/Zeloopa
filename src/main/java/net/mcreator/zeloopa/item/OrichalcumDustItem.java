...
public class OrichalcumDustItem extends ZeloopaModElements.ModElement {
	@ObjectHolder("zeloopa:orichalcum_dust")
	public static final Item block = null;
	public OrichalcumDustItem(ZeloopaModElements instance) {
		super(instance, 174);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("orichalcum_dust");
		}
