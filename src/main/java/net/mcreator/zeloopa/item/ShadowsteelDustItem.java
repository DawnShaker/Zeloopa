...
public class ShadowsteelDustItem extends ZeloopaModElements.ModElement {
	@ObjectHolder("zeloopa:shadowsteel_dust")
	public static final Item block = null;
	public ShadowsteelDustItem(ZeloopaModElements instance) {
		super(instance, 142);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("shadowsteel_dust");
		}
