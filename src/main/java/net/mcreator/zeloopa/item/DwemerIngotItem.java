...
public class DwemerIngotItem extends ZeloopaModElements.ModElement {
	@ObjectHolder("zeloopa:dwemer_ingot")
	public static final Item block = null;
	public DwemerIngotItem(ZeloopaModElements instance) {
		super(instance, 67);
	}
