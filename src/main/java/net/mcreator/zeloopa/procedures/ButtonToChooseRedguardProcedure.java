...
public class ButtonToChooseRedguardProcedure {
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				ZeloopaMod.LOGGER.warn("Failed to load dependency entity for procedure ButtonToChooseRedguard!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				ZeloopaMod.LOGGER.warn("Failed to load dependency x for procedure ButtonToChooseRedguard!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				ZeloopaMod.LOGGER.warn("Failed to load dependency y for procedure ButtonToChooseRedguard!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				ZeloopaMod.LOGGER.warn("Failed to load dependency z for procedure ButtonToChooseRedguard!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				ZeloopaMod.LOGGER.warn("Failed to load dependency world for procedure ButtonToChooseRedguard!");
			return;
		}
		...
		{
			String _setval = (String) "Redguard";
