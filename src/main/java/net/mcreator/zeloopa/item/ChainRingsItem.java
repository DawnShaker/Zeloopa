...
public class ChainRingsItem extends ZeloopaModElements.ModElement {
	@ObjectHolder("zeloopa:chain_rings")
	public static final Item block = null;
	public ChainRingsItem(ZeloopaModElements instance) {
		super(instance, 120);
	}
