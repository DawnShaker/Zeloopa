...
public class EboniteRawDustItem extends ZeloopaModElements.ModElement {
	@ObjectHolder("zeloopa:ebonite_raw_dust")
	public static final Item block = null;
	public EboniteRawDustItem(ZeloopaModElements instance) {
		super(instance, 192);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("ebonite_raw_dust");
		}
