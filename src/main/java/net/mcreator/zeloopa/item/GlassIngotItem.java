...
public class GlassIngotItem extends ZeloopaModElements.ModElement {
	@ObjectHolder("zeloopa:glass_ingot")
	public static final Item block = null;
	public GlassIngotItem(ZeloopaModElements instance) {
		super(instance, 70);
	}
