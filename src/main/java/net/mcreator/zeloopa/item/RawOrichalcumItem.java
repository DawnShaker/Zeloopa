...
public class RawOrichalcumItem extends ZeloopaModElements.ModElement {
	@ObjectHolder("zeloopa:raw_orichalcum")
	public static final Item block = null;
	public RawOrichalcumItem(ZeloopaModElements instance) {
		super(instance, 100);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("raw_orichalcum");
		}
