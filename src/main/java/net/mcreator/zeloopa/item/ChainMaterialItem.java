...
public class ChainMaterialItem extends ZeloopaModElements.ModElement {
	@ObjectHolder("zeloopa:chain_material")
	public static final Item block = null;
	public ChainMaterialItem(ZeloopaModElements instance) {
		super(instance, 121);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("chain_material");
		}
