...
public class ElvenDustItem extends ZeloopaModElements.ModElement {
	@ObjectHolder("zeloopa:elven_dust")
	public static final Item block = null;
	public ElvenDustItem(ZeloopaModElements instance) {
		super(instance, 167);
	}
