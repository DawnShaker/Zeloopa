...
@OnlyIn(Dist.CLIENT)
public class RaceChooseListP2GuiWindow extends ContainerScreen<RaceChooseListP2Gui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	private PlayerEntity entity;
	private final static HashMap guistate = RaceChooseListP2Gui.guistate;
	public RaceChooseListP2GuiWindow(RaceChooseListP2Gui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
