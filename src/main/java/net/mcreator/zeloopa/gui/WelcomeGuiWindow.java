...
@OnlyIn(Dist.CLIENT)
public class WelcomeGuiWindow extends ContainerScreen<WelcomeGui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	private PlayerEntity entity;
	private final static HashMap guistate = WelcomeGui.guistate;
	public WelcomeGuiWindow(WelcomeGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
