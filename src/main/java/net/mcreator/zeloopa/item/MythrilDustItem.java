...
public class MythrilDustItem extends ZeloopaModElements.ModElement {
	@ObjectHolder("zeloopa:mythril_dust")
	public static final Item block = null;
	public MythrilDustItem(ZeloopaModElements instance) {
		super(instance, 141);
	}
