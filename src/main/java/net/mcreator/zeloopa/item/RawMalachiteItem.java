...
public class RawMalachiteItem extends ZeloopaModElements.ModElement {
	@ObjectHolder("zeloopa:raw_malachite")
	public static final Item block = null;
	public RawMalachiteItem(ZeloopaModElements instance) {
		super(instance, 99);
	}
