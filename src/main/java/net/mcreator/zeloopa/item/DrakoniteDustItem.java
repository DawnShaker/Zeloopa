...
public class DrakoniteDustItem extends ZeloopaModElements.ModElement {
	@ObjectHolder("zeloopa:drakonite_dust")
	public static final Item block = null;
	public DrakoniteDustItem(ZeloopaModElements instance) {
		super(instance, 173);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("drakonite_dust");
		}
