...
public class GlassDustItem extends ZeloopaModElements.ModElement {
	@ObjectHolder("zeloopa:glass_dust")
	public static final Item block = null;
	public GlassDustItem(ZeloopaModElements instance) {
		super(instance, 149);
	}
